...
difference() {
    ...
    union() {
        xcopies(wallWidth * 8, l = enclosureX - (wallWidth * 2))
            cuboid([wallWidth, enclosureY, (enclosureZ - (wallWidth * 4)) / 2]);
        ycopies(wallWidth * 8, l = enclosureY - (wallWidth * 2))
            cuboid([enclosureX, wallWidth, (enclosureZ - (wallWidth * 4)) / 2]);
    }
}
